...
RSpec.describe Nuvemshop do
  context 'with default settings' do
    it { expect(described_class.user_agent).to eq('Nuvemshop Gem(https://github.com/alexandreh92/nuvemshop-ruby)') }
  end

  context 'when user sets settings' do
    before do
    ...
    context 'when delegates configuration' do
